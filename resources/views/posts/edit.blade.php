        ...
        <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
            ...
            <form action="{{route('posts.update', $post->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="file" id="image" name="image"  value="{{$post->image->path}}" accept="image/*"
                    ...
                    <p class="mt-2 text-sm text-gray-500">Current image: {{$post->image->path}}</p>
                    <img src="{{asset('/storage' . '/' . $post->image->path)}}" width="150px" alt="Post's Image">
                </div>
                <button type="submit"
